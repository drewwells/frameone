...
module.exports = function( grunt ) {
	...
	grunt.initConfig({
		...
		meta: {
			banner: "Framework"//"/*! jQuery v<%= pkg.version %> jquery.com | jquery.org/license */"
		},
		compare_size: {
			files: distpaths
		},
	...
	// Default grunt.
	grunt.registerTask( "default", "build:*:* lint min dist:* compare_size" );
